      ...
      <div className="container-max grid gap-8 md:grid-cols-2">
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li className="flex items-center gap-2">
              <a href="mailto:info@myaipartner.co.za" className="hover:text-brand-700">
                info@myaipartner.co.za
              </a>
            </li>
            <li className="flex items-center gap-2">
              <a href="tel:+27XXXXXXXXX" className="hover:text-brand-700">
                +27 X XX XX XXXX
              </a>
            </li>
          </ul>
        ...
        {status === 'sent' ? (
          <div className="card p-8 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold text-green-700">Submission Successful</h3>
